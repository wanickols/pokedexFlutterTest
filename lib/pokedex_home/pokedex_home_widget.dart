...
class PokedexHomeWidget extends StatefulWidget {
  const PokedexHomeWidget({Key key}) : super(key: key);

  @override
  _PokedexHomeWidgetState createState() => _PokedexHomeWidgetState();
}

class _PokedexHomeWidgetState extends State<PokedexHomeWidget> {
                                  ...
                                  children: [
                                    ...
                                    FutureBuilder<ApiCallResponse>(
                                      future: GetPokemonCall.call(
                                        id: functions.plusOne(pokemonListIndex),
                                      ),
                                      builder: (context, snapshot) {
                                        // Customize what your widget looks like when it's loading.
                                        if (!snapshot.hasData) {
